      ...
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-300 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
        ...
        <form>
          <div>
            ...
            <input type="text" placeholder="Khanh dev" className="input input-bordered w-full h-10" />
          </div>
          <div>
            <label className="label p-2">
              <span className="text-base label-text">Username</span>
            </label>
            <input type="text" placeholder="Khanhdev" className="input input-bordered w-full h-10" />
          </div>
          <div>
            <label className="label p-2">
          ...
          <a href="#" className="text-sm hover: underline hover:text-blue-400 mt-4 inline-block">Already have an account?</a>
          <div>
